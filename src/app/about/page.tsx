  ...
  return (
    <>
      <section>
        <div className="w-full h-[420px]  relative ">
          ...
          <p className="absolute select-none font-bold m-20 text-justify text-white text-xl">
            ...
            for guidance.<br/> Krishna shares profound teachings on duty (dharma),
            action (karma), and the different paths to spiritual growth (yoga).
            He explains the nature of the soul, the importance of living a
            righteous life, and the power of devotion (bhakti). The Gita offers
            timeless wisdom on how to navigate life's challenges with clarity
            and purpose. It inspires people to live with integrity, perform
            their duties selflessly, and seek a deeper connection with the
            divine. Even today, the Bhagavad Gita continues to guide and uplift
            those seeking spiritual understanding and inner peace.
          </p>
        </div>
      </section>
      ...
      <section className="mt-10">
        mythical arts and drwaings related to Mahabharata
      </section>
